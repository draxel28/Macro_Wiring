...
import iso9001 from "../assets/components/certificates/iso9001.png";
import iso14001 from "../assets/components/certificates/iso4001.png";
import ulLogo from "../assets/components/certificates/ul-logo.png";
import rohs from "../assets/components/certificates/rohs.png";
import ecovadis from "../assets/components/certificates/ecodavis.png";
...
const certData = [
  ...
  },
  {
    ...
    items: [
      {
        name: "UL Recognized",
        description: "Wire Harness & Power Cord Safety (E89012)",
        image: ulLogo,
        status: "Active",
      },
      {
        name: "RoHS & REACH",
        description: "Environmental Material Compliance",
        image: rohs,
        status: "Compliant",
      },
    ],
    ...
    items: [
      {
        ...
        description: "Sustainability & CSR Rating",
        image: ecovadis,
        status: "Awarded",
      },
      {
        name: "SEIPI Member",
        description: "Semiconductor & Electronics Industry",
        image: seipi,
        status: "Member",
      },
      {
        name: "Best Employer",
        description: "PEZA Outstanding Employer Award",
        image: bestEmployer,
        status: "Awarded",
      },
      {
      ...
      <div className="bg-gray-900 text-white py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Our commitment to excellence is verified by international governing
            bodies and global industry standards.
          </p>
        </div>
      </div>
